					...
					<li class="skill-item fade-in">
						<div class="skill-item-content">
							<div class="skill-item-content-visible">
								<svg
									class="skill-item-content-vector"
